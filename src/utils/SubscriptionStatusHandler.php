...
class VindiSubscriptionStatusHandler
{
    ...
    public function __construct(VindiSettings $vindi_settings)
    {
        ...
        add_filter('woocommerce_subscriptions_registered_statuses', array(
            &$this, 'register_subscription_waiting_status'
        ), 100, 1);

        add_filter('wcs_subscription_statuses', array(
            &$this, 'add_subscription_waiting_status'
        ), 100, 1);

        add_action('woocommerce_can_subscription_be_updated_to', array(
            &$this,'update_subscription_waiting_status'
        ), 100, 3);
    ...
    /**
     * Register Waiting Payment new status 
     * @param array $subscription_statuses
     * @return array
     */
    ...
    /**
     * Add the new status to the statuses list
     * @param array $subscription_statuses
     * @return array
     */
    ...
    /**
     * Controlls the permissions for status update
     * @param bool $can_be_updated
     * @param string $new_status
