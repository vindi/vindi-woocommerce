  ...
  <div class='vindi-new-cc-data' style="<?php if(!empty($user_payment_profile)) echo 'display: none'; ?>">
    ...
    <div class="vindi_cc_form-container">
      ...
      <div class="field-container">
        ...
        <input id="vindi_cc_cardnumber" name="vindi_cc_number" type="text" inputmode="numeric" autocomplete="off" placeholder="•••• •••• •••• ••••">
        <img
      ...
      <div class="field-container">
        ...
        <input id="vindi_cc_securitycode" name="vindi_cc_cvc" type="text" inputmode="numeric" placeholder="CVC" autocomplete="off">
      </div>
